...
// 🛡️ حماية لمنع تنصيب رقم البوت الأساسي كبوت فرعي وتدمير الجلسة
let mainBotNumber = extractNumber(conn.user.jid || '')
if (number === mainBotNumber) {
    return m.reply(`◆━═━═━═━═━═━═━═━═━◆\n🃏 *𝐓𝐇𝐄 𝑱𝑶𝑲𝑬𝑹* ➾ *𝐈𝐭𝐚𝐜𝐡𝐢♞*\n◆━═━═━═━═━═━═━═━═━◆\n│ ❌ *عملية مرفوضة*\n│ لا يمكنك تنصيب رقم البوت الأساسي كبوت فرعي!\n◆━═━═━═━═━═━═━═━═━◆\n*👑 𝐈𝐭𝐚𝐜𝐡𝐢♞ | 𝐓𝐇𝐄 𝑱𝑶𝑲𝑬𝑹 ᜰ*`)
}
        ...
        if (connection === 'close') {
            ...
            if (reason === 440 || reason === 405 || reason === 401 || reason === 403) {
                ...
                if (reason === 405 || reason === 401 || reason === 403) {
                    try { 
                        // تم تصحيح طريقة الحذف الآمن للمجلد لتفادي أخطاء الأذونات
