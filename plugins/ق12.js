...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    const imageUrl = 'https://i.postimg.cc/2yNy0QRm/3a89b16821a26b79273c9c6d8aeaf14e.jpg';
...
> 亗 𝐉𝐨𝐤𝐞𝐫 𝐁𝐨𝐭 ✰ 𝐁𝐲 𝐈𝐭𝐚𝐜𝐡𝐢 ♞`;
    ...
    console.error('[Joker-Bank]', e);
    await conn.sendMessage(m.chat, {
      text: theme.build([
        { type: 'title', text: '🃏 الـجـوكـر: "خطأ"' },
        { type: 'warning', text: 'حدث خطأ أثناء تحميل لوحة البنك والقلاع' }
      ])
    }, { quoted: m });
  }
}
