...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    // التفاعل بإيموجي القسم الخاص بالتسلية
...
handler.help = ['ق11', 'entertainment', 'الترفيه', 'التسلية'];
handler.tags = ['main'];
handler.command = /^(ق11|entertainment|الترفيه|التسلية)$/i;
