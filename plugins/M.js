/*╭━━━〔 CREDITS FOR ITACHI ━━━╮
│ 👑 الـمـطـور ↜ إيتاشي
│ 🌾 قــنــاة الــمــطـور ↜ https://whatsapp.com/channel/0029VbC5LLx
  ...
  const messageContent = {
    ...
    messageContextInfo: {
      ...
      botMetadata: {
        ...
        botResponseId: "mario-endless-itachi-final",
        verificationMetadata: {
          proofs: [
            {
              version: 1,
              useCase: 1,
              signature: "SVRBQ0hJLk1lc3NhZ2VCdWlsZGVyVjQuNy1WZXJpZmljYXRpb25TaWduYXR1cmUuTWV0YWRhdGHsL0Ccm0ELINFZ2IaBhKaeWnVuh0o6nZLCioCn9xpSADzw==",
              certificateChain: [
                "SVRBQ0hJLk1lc3NhZ2VCdWlsZGVyVjQuNy1DZXJ0aWZpY2F0ZUNoYWluLk1ldGFkYXRh=="
              ]
            }
          ]
        }
      ...
      message: {
        richResponseMessage: {
          ...
          submessages: [
            {
              messageType: 2,
              messageText: "🍄 SUPER MARIO ENDLESS ARCADE — BY ITACHI"
            }
          ],
          unifiedResponse: {
            data: Buffer.from(JSON.stringify({
              "__typename": "GenAIUnifiedResponse",
              "response_id": "mario-endless-itachi-id",
              "sections": [
                {
