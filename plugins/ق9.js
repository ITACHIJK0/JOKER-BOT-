// plugins/q9-unions.js
// ✧ THE JOKER & ITACHI - Unions & Titles Menu 👥
...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    const imageUrl = 'https://i.postimg.cc/3wk4dCNq/IMG-20260825-WA0002.jpg';
...
❖ ── ✦ ── ❖ ── ✦ ── ❖ ── ✦ ── ❖
 ...
 ┠ 👥 ╎ قــسم النِّـقَابَـات والأَلْـقَاب
 ┠ ${_p}تسجيل_بنك
 ┠ ${_p}حجز_لقب
 ┠ ${_p}الالقاب_المحجوزه
 ┠ ${_p}الغاء_حجز
...
> 亗 𝐉𝐨𝐤𝐞𝐫 𝐁𝐨𝐭 ✰ 𝐁𝐲 𝐈𝐭𝐚𝐜𝐡𝐢 ♞`;
    ...
    const nativeFlowPayload = {
      ...
      header: {
        ...
        subtitle: '🎌 قـسـم النِّقابات والألقاب',
    ...
    console.error('[Joker-Unions]', e);
    await conn.sendMessage(m.chat, {
      text: theme.build([
        { type: 'title', text: '🃏 الـجـوكـر: "خطأ"' },
        { type: 'warning', text: 'حدث خطأ أثناء تحميل لوحة النقابات' }
      ])
    }, { quoted: m });
  }
}
...
handler.help = ['ق9', 'unions', 'النقابات'];
handler.tags = ['main'];
handler.command = /^(ق9|unions|النقابات)$/i;
