...
let handler = async (m, { conn, text, usedPrefix, command, groupMetadata }) => {
    try {
        ...
        // جلب المشاركين بطريقة آمنة وشاملة لتجنب خطأ العدد غير الكافي
        try {
        ...
        // إذا فشلت الطريقة الأولى، نحاول جلبهم من كاش البوت أو الـ chat
        if (!ps || ps.length === 0) {
        ...
        const ownerNumbers = global.owner ? global.owner.map(o => (Array.isArray(o) ? o[0] : o) + '@s.whatsapp.net') : [];
