// plugins/q13-developer.js
// ✧ THE JOKER & ITACHI - Developer Menu 🔧 (Owner Only)
...
let handler = async (m, { conn, usedPrefix: _p, isROwner, isOwner }) => {
  ...
  try {
    ...
    // التفاعل بإيموجي القسم الخاص بالمطور
    await conn.sendMessage(m.chat, { react: { text: '👑', key: m.key } });

    const imageUrl = 'https://i.postimg.cc/MZsKCfdF/33196783be4bec38a0da9ddd84edb31b.jpg';
...
> 亗 𝐉𝐨𝐤𝐞𝐫 𝐁𝐨𝐭 ✰ 𝐁𝐲 𝐈𝐭𝐚𝐜𝐡𝐢 ♞`;
    ...
    console.error('[Joker-Developer]', e);
    await conn.sendMessage(m.chat, {
      text: theme.build([
        { type: 'title', text: '🃏 الـجـوكـر: "خطأ"' },
        { type: 'warning', text: 'حدث خطأ أثناء تحميل لوحة المطور' }
      ])
    }, { quoted: m });
  }
}
...
handler.help = ['ق13', 'dev', 'developer', 'قسم_المطور'];
handler.tags = ['main'];
handler.command = /^(ق13|dev|developer|قسم_المطور)$/i;
handler.rowner = true;
