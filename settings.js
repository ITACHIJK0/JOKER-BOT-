...
// ========== رسائل dfail (تنسيق تفاعلي نظيف مع ظهور نص الخطأ وزر القناة) ==========                                          
global.dfailMessages = {                                                          
    rowner: {
        body: '🚫 *هذا الأمر مخصص لمطوري البوت فقط* 👑',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Developer',
        buttons: [{ name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '📢 عرض القناة الرسمية', url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z', merchant_url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z' }) }]
    },
    owner: {
        body: '🚫 *هذا الأمر مخصص لمطوري البوت فقط* 👑',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Developer',
    ...
    mods: {
        body: '☠️ *هذا الأمر مخصص للمشرفين المعتمدين فقط*',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Mods',
        buttons: [{ name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '📢 عرض القناة الرسمية', url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z', merchant_url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z' }) }]
    },                                                      
    premium: {
        body: '⭐ *هذا الأمر مخصص للمشتركين المميزين فقط*',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Premium',
        buttons: [{ name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '📢 عرض القناة الرسمية', url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z', merchant_url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z' }) }]
    },                                                  
    group: {
        body: '👥 *هذا الأمر مخصص للاستخدام داخل المجموعات فقط*',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Groups',
        buttons: [{ name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '📢 عرض القناة الرسمية', url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z', merchant_url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z' }) }]
    },                                                     
    private: {
        body: '📱 *هذا الأمر يعمل في المحادثات الخاصة فقط*',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Private',
        buttons: [{ name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '📢 عرض القناة الرسمية', url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z', merchant_url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z' }) }]
    },                                                      
    admin: {
        body: '👑 *هذا الأمر مخصص لمشرفي المجموعة فقط*',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Admins',
        buttons: [{ name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '📢 عرض القناة الرسمية', url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z', merchant_url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z' }) }]
    },
    botAdmin: {
        body: '🤖 *يجب أن أكون مشرفاً (Admin) لتنفيذ هذا الأمر*',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Bot Admin',
        buttons: [{ name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '📢 عرض القناة الرسمية', url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z', merchant_url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z' }) }]
    },                                               
    unreg: {
        body: '📝 *عليك التسجيل أولاً لاستخدام البوت*',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Register',
        buttons: [{ name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '📢 عرض القناة الرسمية', url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z', merchant_url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z' }) }]
    },                                                       
    restrict: {
        body: '⚠️ *هذا الأمر معطل حالياً من قِبل المطور*',
        footer: '𝐓𝐇𝐄 𝐉𝐎𝐊𝐄𝐑 ᜰ Restricted',
        buttons: [{ name: 'cta_url', buttonParamsJson: JSON.stringify({ display_text: '📢 عرض القناة الرسمية', url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z', merchant_url: 'https://whatsapp.com/channel/0029VbDHUIRGzzKUabkgin1z' }) }]
    }                                               
}                                                                             

// ========== إزالة الروابط العشوائية وتثبيت القناة فقط ==========                                          
